<template>
  <div v-if="isOpen" class="auth-modal" @click="handleBackdropClick">
    <div class="auth-modal__content" @click.stop>
      ...
      <LoginForm v-if="mode === 'login'" @switch-mode="switchMode" @login-success="handleLoginSuccess" />
      <RegisterForm v-else @switch-mode="switchMode" @register-success="handleRegisterSuccess" />
    </div>
  </div>
</template>
