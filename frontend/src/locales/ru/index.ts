export default {
  ...
  search: {
    ...
    toursNotFound: 'Туры не найдены. Попробуйте изменить параметры поиска.',
    options: 'Опции',
    autoSetByPackage: 'Автоматически устанавливается на основе выбранного пакета',
    childrenAges: 'Возраст детей',
    childAge: 'Возраст ребенка',
    childAgeNumber: 'Возраст ребенка',
    age: 'Возраст'
  },
  home: {
  ...
  bookings: {
    ...
    insuranceDescription: {
      standard: 'Стандартная страховка на 10000 EUR',
      extended: 'Расширенная страховка',
      none: 'Без страховки'
    },
    transfer: 'Трансфер',
    transferDescription: {
      group: 'Групповой трансфер на автобусе',
      individual: 'Индивидуальный трансфер',
      vip: 'VIP индивидуальный трансфер'
    },
    covid19: 'COVID-19',
    covid19Description: 'Дополнительная страховка от COVID-19',
    included: 'Включено',
    statusLabel: 'Статус',
