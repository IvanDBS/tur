    ...
    <div class="container">
      ...
      <div class="auth-status">
        ...
        <div class="status-card">
          <div class="status-item">
            ...
            <span class="status-value" :class="{ 'status--success': authStore.isAuthenticated, 'status--error': !authStore.isAuthenticated }">
          ...
          <div v-if="authStore.error" class="status-item">
            ...
            <span class="status-value status--error">{{ authStore.error }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="auth-actions">
        ...
        <div class="action-buttons">
          ...
          <button v-if="authStore.isAuthenticated" @click="handleLogout" class="btn btn--secondary">
            Выйти
          </button>
